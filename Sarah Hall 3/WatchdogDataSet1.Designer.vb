...
Namespace WatchdogDataSet1TableAdapters
    ...
    Partial Public Class Event_Current_StateTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [Event_Current_State] WHERE (([Row_ID] = @Original_Row_ID) AND ([Last"& _ 
                ...
                "Door) AND ([Doorbell] = @Original_Doorbell) AND ([Car_West] = @Original_Car_West"& _ 
                ") AND ([Car_East] = @Original_Car_East))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Event_Current_State] SET [Row_ID] = @Row_ID, [Last_Update] = @Last_Update"& _ 
                ...
                "ow_South, [Basement_Window_North] = @Basement_Window_North, [Basement_Storage_Do"& _ 
                "or] = @Basement_Storage_Door, [Doorbell] = @Doorbell, [Car_West] = @Car_West, [C"& _ 
                "ar_East] = @Car_East WHERE (([Row_ID] = @Original_Row_ID) AND ([Last_Update] = @"& _ 
                "Original_Last_Update) AND ([Garage_Door] = @Original_Garage_Door) AND ([Garage_W"& _ 
                "indow_South] = @Original_Garage_Window_South) AND ([Garage_Window_North] = @Orig"& _ 
                "inal_Garage_Window_North) AND ([Garage_Outside_Door] = @Original_Garage_Outside_"& _ 
                "Door) AND ([Garage_Outside_Door_Lock] = @Original_Garage_Outside_Door_Lock) AND "& _ 
                "([Garage_Inside_Door] = @Original_Garage_Inside_Door) AND ([Garage_Inside_Door_L"& _ 
                "ock] = @Original_Garage_Inside_Door_Lock) AND ([Kitchen_Window] = @Original_Kitc"& _ 
                "hen_Window) AND ([Back_Door] = @Original_Back_Door) AND ([Back_Door_Lock] = @Ori"& _ 
                "ginal_Back_Door_Lock) AND ([Great_Room_Window_South] = @Original_Great_Room_Wind"& _ 
                "ow_South) AND ([Great_Room_Window_North] = @Original_Great_Room_Window_North) AN"& _ 
                "D ([Play_Room_Window_South] = @Original_Play_Room_Window_South) AND ([Play_Room_"& _ 
                "window_North] = @Original_Play_Room_window_North) AND ([Famiy_Room_Window_South]"& _ 
                " = @Original_Famiy_Room_Window_South) AND ([Family_Room_Window_Front_South] = @O"& _ 
                "riginal_Family_Room_Window_Front_South) AND ([Family_Room_Window_Front_Middle] ="& _ 
                " @Original_Family_Room_Window_Front_Middle) AND ([Family_Room_Window_Front_North"& _ 
                "] = @Original_Family_Room_Window_Front_North) AND ([Front_Door] = @Original_Fron"& _ 
                "t_Door) AND ([Front_Door_Lock] = @Original_Front_Door_Lock) AND ([Dining_Room_Wi"& _ 
                "ndow_South] = @Original_Dining_Room_Window_South) AND ([Dining_Room_Window_North"& _ 
                "] = @Original_Dining_Room_Window_North) AND ([Master_Bath_Window] = @Original_Ma"& _ 
                "ster_Bath_Window) AND ([Master_Bedroom_Window_South] = @Original_Master_Bedroom_"& _ 
                "Window_South) AND ([Master_Bedroom_Window_Back_South] = @Original_Master_Bedroom"& _ 
                "_Window_Back_South) AND ([Master_Bedroom_Window_Back_North] = @Original_Master_B"& _ 
                "edroom_Window_Back_North) AND ([Sydney_Bedroom_Window] = @Original_Sydney_Bedroo"& _ 
                "m_Window) AND ([Ethan_Bedroom_Window] = @Original_Ethan_Bedroom_Window) AND ([Sp"& _ 
                "are_Bedroom_Window_North] = @Original_Spare_Bedroom_Window_North) AND ([Spare_Be"& _ 
                "droom_Window_South] = @Original_Spare_Bedroom_Window_South) AND ([Mailbox] = @Or"& _ 
                "iginal_Mailbox) AND ([Basement_Door] = @Original_Basement_Door) AND ([Basement_D"& _ 
                "oor_Lock] = @Original_Basement_Door_Lock) AND ([Basement_Window_South] = @Origin"& _ 
                "al_Basement_Window_South) AND ([Basement_Window_North] = @Original_Basement_Wind"& _ 
                "ow_North) AND ([Basement_Storage_Door] = @Original_Basement_Storage_Door) AND (["& _ 
                "Doorbell] = @Original_Doorbell) AND ([Car_West] = @Original_Car_West) AND ([Car_"& _ 
                "East] = @Original_Car_East));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Row_ID, Last_Update, Garage_Door, Garage_W"& _ 
                "indow_South, Garage_Window_North, Garage_Outside_Door, Garage_Outside_Door_Lock,"& _ 
                " Garage_Inside_Door, Garage_Inside_Door_Lock, Kitchen_Window, Back_Door, Back_Do"& _ 
                "or_Lock, Great_Room_Window_South, Great_Room_Window_North, Play_Room_Window_Sout"& _ 
                "h, Play_Room_window_North, Famiy_Room_Window_South, Family_Room_Window_Front_Sou"& _ 
                "th, Family_Room_Window_Front_Middle, Family_Room_Window_Front_North, Front_Door,"& _ 
                " Front_Door_Lock, Dining_Room_Window_South, Dining_Room_Window_North, Master_Bat"& _ 
                "h_Window, Master_Bedroom_Window_South, Master_Bedroom_Window_Back_South, Master_"& _ 
                "Bedroom_Window_Back_North, Sydney_Bedroom_Window, Ethan_Bedroom_Window, Spare_Be"& _ 
                "droom_Window_North, Spare_Bedroom_Window_South, Mailbox, Basement_Door, Basement"& _ 
                "_Door_Lock, Basement_Window_South, Basement_Window_North, Basement_Storage_Door,"& _ 
                " Doorbell, Car_West, Car_East FROM Event_Current_State WHERE (Last_Update = @Las"& _ 
                "t_Update)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Row_ID, Last_Update, Garage_Door, Garage_Window_South, Garage_Window_North"& _ 
                ...
                "h, Basement_Window_North, Basement_Storage_Door, Doorbell, Car_West, Car_East FR"& _ 
                "OM Event_Current_State"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Doorbell FROM Event_Current_State WHERE (Row_ID = 1)"
        ...
        Public Overloads Overridable Function Delete( _
                    ...
                    ByVal Original_Car_East As Integer) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(38).Value = CType(Original_Doorbell,Integer)
            Me.Adapter.DeleteCommand.Parameters(39).Value = CType(Original_Car_West,Integer)
            Me.Adapter.DeleteCommand.Parameters(40).Value = CType(Original_Car_East,Integer)
        ...
        Public Overloads Overridable Function Update( _
            ...
            Me.Adapter.UpdateCommand.Parameters(38).Value = CType(Doorbell,Integer)
            Me.Adapter.UpdateCommand.Parameters(39).Value = CType(Car_West,Integer)
            Me.Adapter.UpdateCommand.Parameters(40).Value = CType(Car_East,Integer)
            Me.Adapter.UpdateCommand.Parameters(41).Value = CType(Original_Row_ID,Integer)
            Me.Adapter.UpdateCommand.Parameters(42).Value = CType(Original_Last_Update,Date)
            Me.Adapter.UpdateCommand.Parameters(43).Value = CType(Original_Garage_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(44).Value = CType(Original_Garage_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(45).Value = CType(Original_Garage_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(46).Value = CType(Original_Garage_Outside_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(47).Value = CType(Original_Garage_Outside_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(48).Value = CType(Original_Garage_Inside_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(49).Value = CType(Original_Garage_Inside_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(50).Value = CType(Original_Kitchen_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(51).Value = CType(Original_Back_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(52).Value = CType(Original_Back_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(53).Value = CType(Original_Great_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(54).Value = CType(Original_Great_Room_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(55).Value = CType(Original_Play_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(56).Value = CType(Original_Play_Room_window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(57).Value = CType(Original_Famiy_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(58).Value = CType(Original_Family_Room_Window_Front_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(59).Value = CType(Original_Family_Room_Window_Front_Middle,Integer)
            Me.Adapter.UpdateCommand.Parameters(60).Value = CType(Original_Family_Room_Window_Front_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(61).Value = CType(Original_Front_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(62).Value = CType(Original_Front_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(63).Value = CType(Original_Dining_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(64).Value = CType(Original_Dining_Room_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(65).Value = CType(Original_Master_Bath_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(66).Value = CType(Original_Master_Bedroom_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(67).Value = CType(Original_Master_Bedroom_Window_Back_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(68).Value = CType(Original_Master_Bedroom_Window_Back_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(69).Value = CType(Original_Sydney_Bedroom_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(70).Value = CType(Original_Ethan_Bedroom_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(71).Value = CType(Original_Spare_Bedroom_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(72).Value = CType(Original_Spare_Bedroom_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(73).Value = CType(Original_Mailbox,Integer)
            Me.Adapter.UpdateCommand.Parameters(74).Value = CType(Original_Basement_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(75).Value = CType(Original_Basement_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(76).Value = CType(Original_Basement_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(77).Value = CType(Original_Basement_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(78).Value = CType(Original_Basement_Storage_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(79).Value = CType(Original_Doorbell,Integer)
            Me.Adapter.UpdateCommand.Parameters(80).Value = CType(Original_Car_West,Integer)
            Me.Adapter.UpdateCommand.Parameters(81).Value = CType(Original_Car_East,Integer)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Car_West As Integer,  _
                    ByVal Original_Car_East As Integer) As Integer
            Return Me.Update(Row_ID, Original_Last_Update, Garage_Door, Garage_Window_South, Garage_Window_North, Garage_Outside_Door, Garage_Outside_Door_Lock, Garage_Inside_Door, Garage_Inside_Door_Lock, Kitchen_Window, Back_Door, Back_Door_Lock, Great_Room_Window_South, Great_Room_Window_North, Play_Room_Window_South, Play_Room_window_North, Famiy_Room_Window_South, Family_Room_Window_Front_South, Family_Room_Window_Front_Middle, Family_Room_Window_Front_North, Front_Door, Front_Door_Lock, Dining_Room_Window_South, Dining_Room_Window_North, Master_Bath_Window, Master_Bedroom_Window_South, Master_Bedroom_Window_Back_South, Master_Bedroom_Window_Back_North, Sydney_Bedroom_Window, Ethan_Bedroom_Window, Spare_Bedroom_Window_North, Spare_Bedroom_Window_South, Mailbox, Basement_Door, Basement_Door_Lock, Basement_Window_South, Basement_Window_North, Basement_Storage_Door, Doorbell, Car_West, Car_East, Original_Row_ID, Original_Last_Update, Original_Garage_Door, Original_Garage_Window_South, Original_Garage_Window_North, Original_Garage_Outside_Door, Original_Garage_Outside_Door_Lock, Original_Garage_Inside_Door, Original_Garage_Inside_Door_Lock, Original_Kitchen_Window, Original_Back_Door, Original_Back_Door_Lock, Original_Great_Room_Window_South, Original_Great_Room_Window_North, Original_Play_Room_Window_South, Original_Play_Room_window_North, Original_Famiy_Room_Window_South, Original_Family_Room_Window_Front_South, Original_Family_Room_Window_Front_Middle, Original_Family_Room_Window_Front_North, Original_Front_Door, Original_Front_Door_Lock, Original_Dining_Room_Window_South, Original_Dining_Room_Window_North, Original_Master_Bath_Window, Original_Master_Bedroom_Window_South, Original_Master_Bedroom_Window_Back_South, Original_Master_Bedroom_Window_Back_North, Original_Sydney_Bedroom_Window, Original_Ethan_Bedroom_Window, Original_Spare_Bedroom_Window_North, Original_Spare_Bedroom_Window_South, Original_Mailbox, Original_Basement_Door, Original_Basement_Door_Lock, Original_Basement_Window_South, Original_Basement_Window_North, Original_Basement_Storage_Door, Original_Doorbell, Original_Car_West, Original_Car_East)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function CheckDoorbell() As Global.System.Nullable(Of Integer)
    ...
    Partial Public Class Insteon_ControlTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As WatchdogDataSet1.Insteon_ControlDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As WatchdogDataSet1.Insteon_ControlDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As WatchdogDataSet1.Insteon_ControlDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class Temp_ControlTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As WatchdogDataSet1.Temp_ControlDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As WatchdogDataSet1.Temp_ControlDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As WatchdogDataSet1.Temp_ControlDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
