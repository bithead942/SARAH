...
Public Class Sarah
    ...
    Private Sub Sarah_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        Event_HistoryTableAdapter.InsertQuery("9012", Now)
    ...
    Private Sub Sarah_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Event_HistoryTableAdapter.InsertQuery("9011", Now)
    ...
    Private Sub InitializeSpeechRecognitionEngine()
        ...
        myCommands.Add("Wake up Mom")
        myCommands.Add("Wake Mom Up")
        myCommands.Add("Wake up Dad")
        myCommands.Add("Wake Dad Up")
        myCommands.Add("Call Ethan")
    ...
    Private Sub Recognizer_SpeechRecognized(ByVal sender As Object, ByVal e As SpeechRecognizedEventArgs) Handles Recognizer.SpeechRecognized
        ...
        Event_HistoryTableAdapter.InsertQuery("9013", Now)
        ...
        If e.Result.Confidence * 100 >= 70 Then   'Be at least 70% sure 
            'IdentifySpeaker
    ...
    Private Sub SpeechToAction(ByVal strCommand As String)
        ...
        Select Case UCase(strCommand)
            ...
            Case "SERVER ROOM TEMPERATURE"
                UpdateTemp()
                If Not bDataFeedError Then
                    strMessage = "The server room temperature is " & Temp_Current_StateDataGridView.Rows(0).Cells(7).Value.ToString & " degrees"
                Else
                    strMessage = "Sorry, I am unable to process that request at this time."
                End If
            Case "GARAGE TEMPERATURE"
                UpdateTemp()
                If Not bDataFeedError Then
                    strMessage = "The garage temperature is " & Temp_Current_StateDataGridView.Rows(0).Cells(6).Value.ToString & " degrees"
                Else
                    strMessage = "Sorry, I am unable to process that request at this time."
                End If
            Case "WHAT CAN I SAY"
            ...
            Case "WAKE UP MOM", "WAKE MOM UP"
                If Hour(Now) <= 10 And Hour(Now) >= 7 Then
                    WakeMom()
                End If
                strMessage = ""
            Case "WAKE UP DAD", "WAKE DAD UP"
                If Hour(Now) <= 10 And Hour(Now) >= 7 Then
                    strMessage = "No, you should let Dad sleep."
                Else
                    strMessage = ""
                End If
            Case "CALL ETHAN"
                strMessage = "Hey you! over there! in the Bob shirt! Come here!"
            ...
            Case "IM EXPECTING COMPANY", "IM EXPECTING GUESTS"
                If Hour(Now) >= 19 Or Hour(Now) <= 7 Then
                    strMessage = "Turning on outside lights"
                    OutsideLightsOn()
                End If
            Case "PLEASE REPEAT"
                strMessage = "Sorry, I didn't hear you clearly.  Please Repeat."
            Case Else
        ...
        'Event_HistoryTableAdapter.InsertQuery("9014", Now)
        Recognizer.RecognizeAsync(RecognizeMode.Multiple)
    End Sub
    ...
    Private Function ProvideGreeting()
        ...
        Select Case iRandom
            ...
            Case 6, 7
                ProvideGreeting = "Yes?"
            Case 8, 9
                ProvideGreeting = "How may I serve you?"
...
#Region "Misc Status"
    ...
    Private Sub WakeMom()
        ...
        WavPlay1.SoundLocation() = "c:\program files\watchdog\BeautifulMorning.wav"
        Try
            WavPlay1.PlaySync()
        Catch ex As Exception
            Exit Sub
...
#Region "Weather Update"
    ...
    Private Sub UpdateWeather()
        ...
        Try
            ...
            'Get Temps
            strCurrentCondition = xmlTemps.Tables(1).Rows(0).ItemArray(1).ToString.Trim & " degrees and " & xmlTemps.Tables(1).Rows(0).ItemArray(0).ToString.Trim
...
#Region "Insteon Interface"
    ...
    Public Sub OutsideLightsOn()
        Insteon_ControlTableAdapter.Request_State_Change(1, "15.FD.A1")
        Thread.Sleep(100)
        Insteon_ControlTableAdapter.Request_State_Change(1, "17.A6.A9")
        tLightsOff.Start()
    End Sub

    Public Sub OutsideLightsOff()
        Insteon_ControlTableAdapter.Request_State_Change(0, "15.FD.A1")
        Thread.Sleep(100)
        Insteon_ControlTableAdapter.Request_State_Change(0, "17.A6.A9")
...
#End Region
    ...
    Private Sub Event_Current_StateBindingNavigatorSaveItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Me.Validate()
        Me.Event_Current_StateBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.WatchdogDataSet1)
