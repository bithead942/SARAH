    ...
    Partial Public Class Event_Current_StateTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Event_Current_State] WHERE (([Row_ID] = @Original_Row_ID) AND "& _ 
                ...
                "ernet_Link) AND ([Lizard_Fed] = @Original_Lizard_Fed))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Event_Current_State] ([Row_ID], [Last_Update], [Garage_Door], "& _ 
                ...
                ") VALUES (@Row_ID, @Last_Update, @Garage_Door, @Garage_Window_South, @Garage_Win"& _ 
                "dow_North, @Garage_Outside_Door, @Garage_Outside_Door_Lock, @Garage_Inside_Door,"& _ 
                " @Garage_Inside_Door_Lock, @Kitchen_Window, @Back_Door, @Back_Door_Lock, @Great_"& _ 
                "Room_Window_South, @Great_Room_Window_North, @Play_Room_Window_South, @Play_Room"& _ 
                "_window_North, @Famiy_Room_Window_South, @Family_Room_Window_Front_South, @Famil"& _ 
                "y_Room_Window_Front_Middle, @Family_Room_Window_Front_North, @Front_Door, @Front"& _ 
                "_Door_Lock, @Dining_Room_Window_South, @Dining_Room_Window_North, @Master_Bath_W"& _ 
                "indow, @Master_Bedroom_Window_South, @Master_Bedroom_Window_Back_South, @Master_"& _ 
                "Bedroom_Window_Back_North, @Sydney_Bedroom_Window, @Ethan_Bedroom_Window, @Spare"& _ 
                "_Bedroom_Window_North, @Spare_Bedroom_Window_South, @Mailbox, @Basement_Door, @B"& _ 
                "asement_Door_Lock, @Basement_Window_South, @Basement_Window_North, @Basement_Sto"& _ 
                "rage_Door, @Server_Room_Motion, @Upstairs_Hallway_Motion, @Great_Room_Motion, @B"& _ 
                "asement_Motion, @Exterior_Motion, @Doorbell, @Telephone, @Car_West, @Car_East, @"& _ 
                "House_Occupied, @Brine_Tank, @Lizard_Habitat_Temp, @Internet_Link, @Lizard_Fed);"& _ 
                ""&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Row_ID, Last_Update, Garage_Door, Garage_Window_South, Garage_Window_No"& _ 
                "rth, Garage_Outside_Door, Garage_Outside_Door_Lock, Garage_Inside_Door, Garage_I"& _ 
                "nside_Door_Lock, Kitchen_Window, Back_Door, Back_Door_Lock, Great_Room_Window_So"& _ 
                "uth, Great_Room_Window_North, Play_Room_Window_South, Play_Room_window_North, Fa"& _ 
                "miy_Room_Window_South, Family_Room_Window_Front_South, Family_Room_Window_Front_"& _ 
                "Middle, Family_Room_Window_Front_North, Front_Door, Front_Door_Lock, Dining_Room"& _ 
                "_Window_South, Dining_Room_Window_North, Master_Bath_Window, Master_Bedroom_Wind"& _ 
                "ow_South, Master_Bedroom_Window_Back_South, Master_Bedroom_Window_Back_North, Sy"& _ 
                "dney_Bedroom_Window, Ethan_Bedroom_Window, Spare_Bedroom_Window_North, Spare_Bed"& _ 
                "room_Window_South, Mailbox, Basement_Door, Basement_Door_Lock, Basement_Window_S"& _ 
                "outh, Basement_Window_North, Basement_Storage_Door, Server_Room_Motion, Upstairs"& _ 
                "_Hallway_Motion, Great_Room_Motion, Basement_Motion, Exterior_Motion, Doorbell, "& _ 
                "Telephone, Car_West, Car_East, House_Occupied, Brine_Tank, Lizard_Habitat_Temp, "& _ 
                "Internet_Link, Lizard_Fed FROM Event_Current_State WHERE (Last_Update = @Last_Up"& _ 
                "date)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Event_Current_State] SET [Row_ID] = @Row_ID, [Last_Update] = @Last_"& _ 
                ...
                "nternet_Link, [Lizard_Fed] = @Lizard_Fed WHERE (([Row_ID] = @Original_Row_ID) AN"& _ 
                "D ([Last_Update] = @Original_Last_Update) AND ([Garage_Door] = @Original_Garage_"& _ 
                "Door) AND ([Garage_Window_South] = @Original_Garage_Window_South) AND ([Garage_W"& _ 
                "indow_North] = @Original_Garage_Window_North) AND ([Garage_Outside_Door] = @Orig"& _ 
                "inal_Garage_Outside_Door) AND ([Garage_Outside_Door_Lock] = @Original_Garage_Out"& _ 
                "side_Door_Lock) AND ([Garage_Inside_Door] = @Original_Garage_Inside_Door) AND (["& _ 
                "Garage_Inside_Door_Lock] = @Original_Garage_Inside_Door_Lock) AND ([Kitchen_Wind"& _ 
                "ow] = @Original_Kitchen_Window) AND ([Back_Door] = @Original_Back_Door) AND ([Ba"& _ 
                "ck_Door_Lock] = @Original_Back_Door_Lock) AND ([Great_Room_Window_South] = @Orig"& _ 
                "inal_Great_Room_Window_South) AND ([Great_Room_Window_North] = @Original_Great_R"& _ 
                "oom_Window_North) AND ([Play_Room_Window_South] = @Original_Play_Room_Window_Sou"& _ 
                "th) AND ([Play_Room_window_North] = @Original_Play_Room_window_North) AND ([Fami"& _ 
                "y_Room_Window_South] = @Original_Famiy_Room_Window_South) AND ([Family_Room_Wind"& _ 
                "ow_Front_South] = @Original_Family_Room_Window_Front_South) AND ([Family_Room_Wi"& _ 
                "ndow_Front_Middle] = @Original_Family_Room_Window_Front_Middle) AND ([Family_Roo"& _ 
                "m_Window_Front_North] = @Original_Family_Room_Window_Front_North) AND ([Front_Do"& _ 
                "or] = @Original_Front_Door) AND ([Front_Door_Lock] = @Original_Front_Door_Lock) "& _ 
                "AND ([Dining_Room_Window_South] = @Original_Dining_Room_Window_South) AND ([Dini"& _ 
                "ng_Room_Window_North] = @Original_Dining_Room_Window_North) AND ([Master_Bath_Wi"& _ 
                "ndow] = @Original_Master_Bath_Window) AND ([Master_Bedroom_Window_South] = @Orig"& _ 
                "inal_Master_Bedroom_Window_South) AND ([Master_Bedroom_Window_Back_South] = @Ori"& _ 
                "ginal_Master_Bedroom_Window_Back_South) AND ([Master_Bedroom_Window_Back_North] "& _ 
                "= @Original_Master_Bedroom_Window_Back_North) AND ([Sydney_Bedroom_Window] = @Or"& _ 
                "iginal_Sydney_Bedroom_Window) AND ([Ethan_Bedroom_Window] = @Original_Ethan_Bedr"& _ 
                "oom_Window) AND ([Spare_Bedroom_Window_North] = @Original_Spare_Bedroom_Window_N"& _ 
                "orth) AND ([Spare_Bedroom_Window_South] = @Original_Spare_Bedroom_Window_South) "& _ 
                "AND ([Mailbox] = @Original_Mailbox) AND ([Basement_Door] = @Original_Basement_Do"& _ 
                "or) AND ([Basement_Door_Lock] = @Original_Basement_Door_Lock) AND ([Basement_Win"& _ 
                "dow_South] = @Original_Basement_Window_South) AND ([Basement_Window_North] = @Or"& _ 
                "iginal_Basement_Window_North) AND ([Basement_Storage_Door] = @Original_Basement_"& _ 
                "Storage_Door) AND ([Server_Room_Motion] = @Original_Server_Room_Motion) AND ([Up"& _ 
                "stairs_Hallway_Motion] = @Original_Upstairs_Hallway_Motion) AND ([Great_Room_Mot"& _ 
                "ion] = @Original_Great_Room_Motion) AND ([Basement_Motion] = @Original_Basement_"& _ 
                "Motion) AND ([Exterior_Motion] = @Original_Exterior_Motion) AND ([Doorbell] = @O"& _ 
                "riginal_Doorbell) AND ([Telephone] = @Original_Telephone) AND ([Car_West] = @Ori"& _ 
                "ginal_Car_West) AND ([Car_East] = @Original_Car_East) AND ([House_Occupied] = @O"& _ 
                "riginal_House_Occupied) AND ([Brine_Tank] = @Original_Brine_Tank) AND ([Lizard_H"& _ 
                "abitat_Temp] = @Original_Lizard_Habitat_Temp) AND ([Internet_Link] = @Original_I"& _ 
                "nternet_Link) AND ([Lizard_Fed] = @Original_Lizard_Fed));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT Row_ID, Last_U"& _ 
                "pdate, Garage_Door, Garage_Window_South, Garage_Window_North, Garage_Outside_Doo"& _ 
                "r, Garage_Outside_Door_Lock, Garage_Inside_Door, Garage_Inside_Door_Lock, Kitche"& _ 
                "n_Window, Back_Door, Back_Door_Lock, Great_Room_Window_South, Great_Room_Window_"& _ 
                "North, Play_Room_Window_South, Play_Room_window_North, Famiy_Room_Window_South, "& _ 
                "Family_Room_Window_Front_South, Family_Room_Window_Front_Middle, Family_Room_Win"& _ 
                "dow_Front_North, Front_Door, Front_Door_Lock, Dining_Room_Window_South, Dining_R"& _ 
                "oom_Window_North, Master_Bath_Window, Master_Bedroom_Window_South, Master_Bedroo"& _ 
                "m_Window_Back_South, Master_Bedroom_Window_Back_North, Sydney_Bedroom_Window, Et"& _ 
                "han_Bedroom_Window, Spare_Bedroom_Window_North, Spare_Bedroom_Window_South, Mail"& _ 
                "box, Basement_Door, Basement_Door_Lock, Basement_Window_South, Basement_Window_N"& _ 
                "orth, Basement_Storage_Door, Server_Room_Motion, Upstairs_Hallway_Motion, Great_"& _ 
                "Room_Motion, Basement_Motion, Exterior_Motion, Doorbell, Telephone, Car_West, Ca"& _ 
                "r_East, House_Occupied, Brine_Tank, Lizard_Habitat_Temp, Internet_Link, Lizard_F"& _ 
                "ed FROM Event_Current_State WHERE (Last_Update = @Last_Update)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.SarahDoor3.My.MySettings.Default.WatchdogConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Row_ID, Last_Update, Garage_Door, Garage_Window_South, Garage_Window_North"& _ 
                ...
                "ernet_Link, Lizard_Fed FROM dbo.Event_Current_State"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Doorbell"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Event_Current_State"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Row_ID"& _ 
                " = 1)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT        House_Occupied"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Event_Current_State"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        ("& _ 
                "Row_ID = 1)"
        ...
        Public Overloads Overridable Function Delete( _
                    ...
                    ByVal Original_Lizard_Fed As Integer) As Integer
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal Lizard_Habitat_Temp As Integer,  _
                    ByVal Internet_Link As Integer,  _
                    ByVal Lizard_Fed As Integer) As Integer
        ...
        Public Overloads Overridable Function Update( _
            ...
            Me.Adapter.UpdateCommand.Parameters(52).Value = CType(Original_Row_ID,Integer)
            Me.Adapter.UpdateCommand.Parameters(53).Value = CType(Original_Last_Update,Date)
            Me.Adapter.UpdateCommand.Parameters(54).Value = CType(Original_Garage_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(55).Value = CType(Original_Garage_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(56).Value = CType(Original_Garage_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(57).Value = CType(Original_Garage_Outside_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(58).Value = CType(Original_Garage_Outside_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(59).Value = CType(Original_Garage_Inside_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(60).Value = CType(Original_Garage_Inside_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(61).Value = CType(Original_Kitchen_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(62).Value = CType(Original_Back_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(63).Value = CType(Original_Back_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(64).Value = CType(Original_Great_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(65).Value = CType(Original_Great_Room_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(66).Value = CType(Original_Play_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(67).Value = CType(Original_Play_Room_window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(68).Value = CType(Original_Famiy_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(69).Value = CType(Original_Family_Room_Window_Front_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(70).Value = CType(Original_Family_Room_Window_Front_Middle,Integer)
            Me.Adapter.UpdateCommand.Parameters(71).Value = CType(Original_Family_Room_Window_Front_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(72).Value = CType(Original_Front_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(73).Value = CType(Original_Front_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(74).Value = CType(Original_Dining_Room_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(75).Value = CType(Original_Dining_Room_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(76).Value = CType(Original_Master_Bath_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(77).Value = CType(Original_Master_Bedroom_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(78).Value = CType(Original_Master_Bedroom_Window_Back_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(79).Value = CType(Original_Master_Bedroom_Window_Back_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(80).Value = CType(Original_Sydney_Bedroom_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(81).Value = CType(Original_Ethan_Bedroom_Window,Integer)
            Me.Adapter.UpdateCommand.Parameters(82).Value = CType(Original_Spare_Bedroom_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(83).Value = CType(Original_Spare_Bedroom_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(84).Value = CType(Original_Mailbox,Integer)
            Me.Adapter.UpdateCommand.Parameters(85).Value = CType(Original_Basement_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(86).Value = CType(Original_Basement_Door_Lock,Integer)
            Me.Adapter.UpdateCommand.Parameters(87).Value = CType(Original_Basement_Window_South,Integer)
            Me.Adapter.UpdateCommand.Parameters(88).Value = CType(Original_Basement_Window_North,Integer)
            Me.Adapter.UpdateCommand.Parameters(89).Value = CType(Original_Basement_Storage_Door,Integer)
            Me.Adapter.UpdateCommand.Parameters(90).Value = CType(Original_Server_Room_Motion,Integer)
            Me.Adapter.UpdateCommand.Parameters(91).Value = CType(Original_Upstairs_Hallway_Motion,Integer)
            Me.Adapter.UpdateCommand.Parameters(92).Value = CType(Original_Great_Room_Motion,Integer)
            Me.Adapter.UpdateCommand.Parameters(93).Value = CType(Original_Basement_Motion,Integer)
            Me.Adapter.UpdateCommand.Parameters(94).Value = CType(Original_Exterior_Motion,Integer)
            Me.Adapter.UpdateCommand.Parameters(95).Value = CType(Original_Doorbell,Integer)
            Me.Adapter.UpdateCommand.Parameters(96).Value = CType(Original_Telephone,Integer)
            Me.Adapter.UpdateCommand.Parameters(97).Value = CType(Original_Car_West,Integer)
            Me.Adapter.UpdateCommand.Parameters(98).Value = CType(Original_Car_East,Integer)
            Me.Adapter.UpdateCommand.Parameters(99).Value = CType(Original_House_Occupied,Integer)
            Me.Adapter.UpdateCommand.Parameters(100).Value = CType(Original_Brine_Tank,Integer)
            Me.Adapter.UpdateCommand.Parameters(101).Value = CType(Original_Lizard_Habitat_Temp,Integer)
            Me.Adapter.UpdateCommand.Parameters(102).Value = CType(Original_Internet_Link,Integer)
            Me.Adapter.UpdateCommand.Parameters(103).Value = CType(Original_Lizard_Fed,Integer)
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Internet_Link As Integer,  _
                    ByVal Original_Lizard_Fed As Integer) As Integer
            Return Me.Update(Row_ID, Original_Last_Update, Garage_Door, Garage_Window_South, Garage_Window_North, Garage_Outside_Door, Garage_Outside_Door_Lock, Garage_Inside_Door, Garage_Inside_Door_Lock, Kitchen_Window, Back_Door, Back_Door_Lock, Great_Room_Window_South, Great_Room_Window_North, Play_Room_Window_South, Play_Room_window_North, Famiy_Room_Window_South, Family_Room_Window_Front_South, Family_Room_Window_Front_Middle, Family_Room_Window_Front_North, Front_Door, Front_Door_Lock, Dining_Room_Window_South, Dining_Room_Window_North, Master_Bath_Window, Master_Bedroom_Window_South, Master_Bedroom_Window_Back_South, Master_Bedroom_Window_Back_North, Sydney_Bedroom_Window, Ethan_Bedroom_Window, Spare_Bedroom_Window_North, Spare_Bedroom_Window_South, Mailbox, Basement_Door, Basement_Door_Lock, Basement_Window_South, Basement_Window_North, Basement_Storage_Door, Server_Room_Motion, Upstairs_Hallway_Motion, Great_Room_Motion, Basement_Motion, Exterior_Motion, Doorbell, Telephone, Car_West, Car_East, House_Occupied, Brine_Tank, Lizard_Habitat_Temp, Internet_Link, Lizard_Fed, Original_Row_ID, Original_Last_Update, Original_Garage_Door, Original_Garage_Window_South, Original_Garage_Window_North, Original_Garage_Outside_Door, Original_Garage_Outside_Door_Lock, Original_Garage_Inside_Door, Original_Garage_Inside_Door_Lock, Original_Kitchen_Window, Original_Back_Door, Original_Back_Door_Lock, Original_Great_Room_Window_South, Original_Great_Room_Window_North, Original_Play_Room_Window_South, Original_Play_Room_window_North, Original_Famiy_Room_Window_South, Original_Family_Room_Window_Front_South, Original_Family_Room_Window_Front_Middle, Original_Family_Room_Window_Front_North, Original_Front_Door, Original_Front_Door_Lock, Original_Dining_Room_Window_South, Original_Dining_Room_Window_North, Original_Master_Bath_Window, Original_Master_Bedroom_Window_South, Original_Master_Bedroom_Window_Back_South, Original_Master_Bedroom_Window_Back_North, Original_Sydney_Bedroom_Window, Original_Ethan_Bedroom_Window, Original_Spare_Bedroom_Window_North, Original_Spare_Bedroom_Window_South, Original_Mailbox, Original_Basement_Door, Original_Basement_Door_Lock, Original_Basement_Window_South, Original_Basement_Window_North, Original_Basement_Storage_Door, Original_Server_Room_Motion, Original_Upstairs_Hallway_Motion, Original_Great_Room_Motion, Original_Basement_Motion, Original_Exterior_Motion, Original_Doorbell, Original_Telephone, Original_Car_West, Original_Car_East, Original_House_Occupied, Original_Brine_Tank, Original_Lizard_Habitat_Temp, Original_Internet_Link, Original_Lizard_Fed)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function CheckHouseOccupied() As Object
